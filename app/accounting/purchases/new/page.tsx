...
export default function NewPurchasePage() {
  ...
  const fetchOptions = async () => {
    ...
    try {
      const response = await fetch('/api/accounting/options?module=purchases');
      if (response.ok) {
  ...
  const handleItemChange = (field: keyof PurchaseItem, value: string | number) => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        throw new Error(errorData.details || 'Failed to create purchase');
      }
      ...
      toast({
        variant: "error",
        title: "Error",
        description: `Failed to create purchase: ${(error as Error).message}`
      });
    } finally {
      setLoading(false);
    }
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Enter the basic details for this purchase invoice</CardDescription>
            </CardHeader>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => handleInputChange('conversion_rate', parseFloat(e.target.value))}
                  />
                </div>
              </div>
            </CardContent>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Add items to this purchase invoice</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              {/* Add Item Form */}
