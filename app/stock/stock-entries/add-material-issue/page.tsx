// app/stock/stock-entries/add-material-issue/page.tsx
"use client";
...
export default function AddMaterialIssuePage() {
  ...
  const [formData, setFormData] = useState({
    ...
    purpose: "Material Issue" as const,
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setLoading(true);
    try {
      if (!formData.company || !formData.from_warehouse || formData.items.length === 0) {
      ...
      if (!response.ok) {
        ...
        throw new Error(errorData.details || 'Failed to create material issue');
      }
      ...
      toast({
        title: "Success",
        description: `Material issue ${result.data.stockEntry.name} created successfully`
      });
      ...
      toast({
        variant: "error",
        title: "Error",
        description: `Failed to create material issue: ${(error as Error).message}`
      });
    } finally {
      setLoading(false);
    }
      ...
      <div className="flex items-center justify-between mb-8">
        <div className="flex items-center">
          ...
          <div>
            ...
            <p className="text-muted-foreground">Create a new material issue</p>
          </div>
        </div>
        <Button 
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Enter the basic details for this material issue</CardDescription>
            </CardHeader>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <Select
                    ...
                    onValueChange={(value) => handleInputChange('from_warehouse', value)}
                  >
                    <SelectTrigger>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Add items to this material issue</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              {/* Add Item Form */}
        ...
        <div>
          ...
          <Card className="sticky top-8">
            ...
            <CardContent className="space-y-4">
              ...
              <Button 
                onClick={handleSubmit} 
                disabled={loading || !formData.company || !formData.from_warehouse || formData.items.length === 0}
                className="w-full"
              >
                <Save className="w-4 h-4 mr-2" />
                {loading ? 'Creating...' : 'Create Material Issue'}
