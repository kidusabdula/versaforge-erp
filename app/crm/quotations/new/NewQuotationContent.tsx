// app/crm/quotations/new/NewQuotationContent.tsx
"use client";
...
export default function NewQuotationContent() {
  ...
  // Get customer or opportunity from URL params if available
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        throw new Error(errorData.details || "Failed to create quotation");
      }

      const data = await response.json();
      toast({
        title: "Success",
        description: `Quotation ${data.data.quotation.name} created successfully`,
      });
  ...
  return (
    <div className="min-h-screen bg-background p-8">
      ...
      {(customerParam || opportunityParam) && (
        <Card className="mb-6 bg-blue-50 border-blue-200">
          <CardContent className="p-4">
            <div className="flex items-center">
              <Users className="w-4 h-4 mr-2" />
              <div>
                <p className="font-medium">Creating quotation for:</p>
        ...
        <div className="lg:col-span-2 space-y-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      handleInputChange("valid_till", e.target.value)
                    }
                  />
                </div>
              </div>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Add items to this quotation</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              {/* Add Item Form */}
